...
CREATE TABLE tempo_adhoc (TASK_ID int8 NOT NULL, PATASK_ID int8 NOT NULL, formType int4, placement int4, note TEXT);
...
ALTER TABLE tempo_pa add column isAdhoc boolean NOT NULL DEFAULT FALSE;
ALTER TABLE tempo_pa add column allowAdhoc boolean NOT NULL DEFAULT TRUE;
ALTER TABLE tempo_pa add column adhocIndex int8 NOT NULL DEFAULT 0;

ALTER TABLE tempo_audit add column is_adhoc boolean NOT NULL DEFAULT FALSE;
...
CREATE TABLE TASK_UBP_LINK (
        ID int8 NOT NULL,
        UBP_INSTANCE_ID int8 NOT NULL,
        TMP_INSTANCE_ID int8 NOT NULL, 
        TASK_ID VARCHAR(255),
