...
create table ahr_report(report_id INTEGER NOT NULL AUTO_INCREMENT, name VARCHAR(100) NOT NULL, description VARCHAR(1000), location VARCHAR(1000) NOT NULL, created_on datetime NOT NULL, modified_on datetime NOT NULL, is_executable BOOLEAN NOT NULL, owner VARCHAR(100) NOT NULL, PRIMARY KEY(report_id)) ;

drop table IF EXISTS ahr_shared_report;
create table ahr_shared_report(access_id INTEGER NOT NULL AUTO_INCREMENT, shared_to VARCHAR(100) NOT NULL, report_id INTEGER NOT NULL, is_role BOOLEAN NOT NULL, PRIMARY KEY(access_id))  ;

CREATE TABLE tempo_acl (id BIGINT NOT NULL auto_increment, action VARCHAR(255), DTYPE VARCHAR(255), PRIMARY KEY (id)) ;
...
CREATE TABLE tempo_notification (id BIGINT NOT NULL, failure_code VARCHAR(255), failure_reason VARCHAR(255), input_xml TEXT, instanceId VARCHAR(255), priority INTEGER, process_id VARCHAR(255), state SMALLINT, PRIMARY KEY (id)) ;
...
CREATE TABLE tempo_task (id BIGINT NOT NULL, creation_date DATETIME, description VARCHAR(255), form_url VARCHAR(255), taskid VARCHAR(255), internal_id INTEGER, PRIMARY KEY (id)) ;
...
CREATE TABLE tempo_pipa_output (id BIGINT NOT NULL AUTO_INCREMENT, task_id VARCHAR(255) NOT NULL, user_owner VARCHAR(255) NOT NULL,  output_xml TEXT, PRIMARY KEY (id)) ;
...
alter table tempo_audit ADD prev_var_data mediumblob;
alter table tempo_audit ADD new_var_data mediumblob;
...
create table intalio_salutation(id int PRIMARY KEY, value VARCHAR(10) NOT NULL);
create table intalio_gender(id int PRIMARY KEY, value VARCHAR(10) NOT NULL);
create table intalio_country(id int PRIMARY KEY, value VARCHAR(100) NOT NULL);
...
CREATE TABLE TEMPO_ITEM (id BIGINT NOT NULL, content_type VARCHAR(255), lastmodified DATETIME, payload LONGBLOB, uri VARCHAR(255), PRIMARY KEY (id)) ;
...
create table module_action (id INT NOT NULL AUTO_INCREMENT,name VARCHAR(255) NOT NULL,parent_id INT, is_action BOOLEAN, native_name VARCHAR(255), is_active BOOLEAN,  PRIMARY KEY(id)) ;

drop table IF EXISTS module_action_access;
create table module_action_access (id INT NOT NULL AUTO_INCREMENT,module_action_id INT NOT NULL,role VARCHAR(255) NOT NULL,PRIMARY KEY(id)) ;
...
SET MAX_LENGTH_INPLACE_LOB 2048;
...
create table STORE_VERSIONS (ID integer not null auto_increment, VERSION bigint, primary key (ID));

create table if not exists ODE_SCHEMA_VERSION(VERSION integer);
insert into ODE_SCHEMA_VERSION values (7);

create table BPEL_ACTIVITY_RECOVERY (ID bigint not null auto_increment, PIID bigint, AID bigint, CHANNEL varchar(255), REASON varchar(1000), DATE_TIME datetime, LDATA_ID bigint, ACTIONS varchar(255), RETRIES integer, INSERT_TIME datetime, MLOCK integer not null, primary key (ID));
...
create table BPEL_EVENT_V2 (ID bigint not null auto_increment, IID bigint, PID bigint, TYPE varchar(255), DETAIL text, SID bigint, INSERT_TIME datetime, 
 ...
 CORR_KEY   text, EXPRESSION  varchar(255), RESULT  varchar(255), P_LINK_NAME  varchar(255), SUCCESS number(1,0) , FAULT_LINE_NO integer, EXPLANATION  varchar(255), 
 VAR_NAME  varchar(255), NEW_VALUE  TEXT,
 MLOCK integer not null, ADHOC_TASK_ID varchar(255), PARENT_TASK_ID  varchar(255), primary key (ID));

create table BPEL_FAULT (ID bigint not null auto_increment, FAULTNAME varchar(255), LDATA_ID bigint, EXPLANATION TEXT, LINE_NUM integer, AID integer, INSERT_TIME datetime, MLOCK integer not null, primary key (ID));
...
create table BPEL_PROCESS (ID bigint not null auto_increment, PROCID varchar(255) not null unique, deployer varchar(255), deploydate datetime, type_name varchar(255), type_ns varchar(255), version bigint, ACTIVE_ smallint, guid varchar(255), INSERT_TIME datetime, MLOCK integer not null, primary key (ID));
...
create table BPEL_SELECTORS (ID bigint not null auto_increment, PIID bigint not null, SELGRPID varchar(255) not null, IDX integer not null, CORRELATION_KEY varchar(255) not null, PROC_TYPE varchar(255) not null, ROUTE_POLICY varchar(16), CORRELATOR bigint not null, INSERT_TIME datetime, MLOCK integer not null, primary key (ID), unique (CORRELATION_KEY, CORRELATOR)) ;
create table BPEL_UNMATCHED (ID bigint not null auto_increment, MEX bigint, CORRELATION_KEY varchar(255), CORRELATOR bigint, INSERT_TIME datetime, MLOCK integer not null, CORRELATOR_PROCESSTYPE varchar(550), primary key (ID)) ;
...
create table LARGE_DATA (ID bigint not null auto_increment, BIN_DATA mediumblob, INSERT_TIME datetime, MLOCK integer not null, primary key (ID)) ;
