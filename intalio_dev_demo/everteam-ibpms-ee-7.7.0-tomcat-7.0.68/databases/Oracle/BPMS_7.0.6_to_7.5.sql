...
insert into module_action_access values(-198,72,'intalio\workflowadministrator');
insert into module_action_access values(-199,72,'intalio\processadministrator');
insert into module_action_access values(-200,72,'intalio\processmanager');

insert into module_action_access values(-201,69,'intalio\breadministrator');

insert into module_action_access values(-202,67,'intalio\eng');
insert into module_action_access values(-203,67,'intalio\employee');
insert into module_action_access values(-204,67,'intalio\manager');

insert into module_action_access values(-205,64,'intalio\workflowadministrator');
insert into module_action_access values(-206,65,'intalio\workflowadministrator');
insert into module_action_access values(-207,66,'intalio\workflowadministrator');

ALTER TABLE DBCONN_PROCESS_SPECIFIC_STATE ADD LAST_MODIFIED  TIMESTAMP DEFAULT SYSDATE;
ALTER TABLE BPEL_PLINK_VAL MODIFY PARTNERROLE VARCHAR2(255);
...
ALTER TABLE ODE_JOB add procid varchar2(255 char);
