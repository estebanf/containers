...
jsx3.Class.defineClass("jsx3.gui.TextBox", jsx3.gui.Block, [jsx3.gui.Form], function(TextBox, TextBox_prototype) {
  ...
  TextBox.VALIDATION[TextBox.VALIDATIONMONEY] = /^\d+\.\d\d$/;
  ...
  TextBox_prototype._ebBlur = function(objEvent, objGUI) {
    ...
    //added null check to fix WF-1680, CDF xml is setting default value null instead of empty string
    if (this.jsxvalue == null)
        this.jsxvalue = "";
    // end fix WF-1680
