...
jsx3.Class.defineInterface("jsx3.gui.Form", null, function(Form, Form_prototype) {
  ...
  //fix for EDGE-3837, added new function setRequired with additional parameter refresh, if true will repaint the widget.
  Form_prototype.setRequired = function(required,refresh) {
    this.jsxrequired = required;
    if(refresh) {
