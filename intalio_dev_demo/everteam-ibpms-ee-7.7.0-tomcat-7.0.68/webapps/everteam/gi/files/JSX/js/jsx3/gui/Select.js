...
/* @JSC */ }
  ...
  Select_prototype.getValue = function() {
    return this.jsxvalue != null ? this.jsxvalue : ""; //Fix for EDGE-3077 need to send empty string instead of null.
  };
