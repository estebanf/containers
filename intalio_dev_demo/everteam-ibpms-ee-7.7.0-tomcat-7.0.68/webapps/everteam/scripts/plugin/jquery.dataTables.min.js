...
*/
/*We have applied some patch in search filter in actual datatables file of version 1.9.4 & minified it using jsmini.
 * */
...
aiIndex[i],"filter",aiFilterColumns))}}function _fnBuildSearchRow(oSettings,aData){var idx=0,aoColumns=oSettings.aoColumns;for(var i=0,len=aoColumns.length;i<len;i++){aData[idx]=_fnDataToSearch(aData[idx],aoColumns[i].sType);if(aoColumns[i].bSearchable)idx++}var sSearch=aData.join("  ");if(sSearch.indexOf("&")!==-1)sSearch=$("<div>").html(sSearch).text();return sSearch.replace(/[\n\r]/g," ")}function _fnFilterCreateSearch(sSearch,bRegex,bSmart,bCaseInsensitive){var asSearch,sRegExpString;if(bSmart){asSearch=
bRegex?sSearch.split(" "):_fnEscapeRegex(sSearch).split(" ");sRegExpString="^(?=.*?"+asSearch.join(")(?=.*?")+").*$";return new RegExp(sRegExpString,bCaseInsensitive?"i":"")}else{sSearch=bRegex?sSearch:_fnEscapeRegex(sSearch);return new RegExp(sSearch,bCaseInsensitive?"i":"")}}function _fnDataToSearch(sData,sType){if(typeof DataTable.ext.ofnSearch[sType]==="function")return DataTable.ext.ofnSearch[sType](sData);else if(sData===null)return"";else if(sType==="html"){var data=sData.replace(/[\r\n]/g,
" ").replace(/<.*?>/g,"");return}else if(typeof sData==="string")return sData.replace(/[\r\n]/g," ");return sData}function _fnEscapeRegex(sVal){var acEscape=["/",".","*","+","?","|","(",")","[","]","{","}","\\","$","^","-"];var reReplace=new RegExp("(\\"+acEscape.join("|\\")+")","g");return sVal.replace(reReplace,"\\$1")}function _fnFeatureHtmlInfo(oSettings){var nInfo=document.createElement("div");nInfo.className=oSettings.oClasses.sInfo;if(!oSettings.aanFeatures.i){oSettings.aoDrawCallback.push({"fn":_fnUpdateInfo,
...
"iTabIndex":0,"oLanguage":{"oAria":{"sSortAscending":": activate to sort column ascending","sSortDescending":": activate to sort column descending"},"oPaginate":{"sFirst":"First","sLast":"Last","sNext":"Next","sPrevious":"Previous"},"sEmptyTable":"No data available in table","sInfo":"Showing _START_ to _END_ of _TOTAL_ entries","sInfoEmpty":"Showing 0 to 0 of 0 entries","sInfoFiltered":"(filtered from _MAX_ total entries)","sInfoPostFix":"","sInfoThousands":",","sLengthMenu":"Show _MENU_ entries",
"sLoadingRecords":"Loading...","sProcessing":"Processing...","sSearch":"Search:","sUrl":"","sZeroRecords":"No matching records found"},"oSearch":$.extend({},DataTable.models.oSearch),"sAjaxDataProp":"aaData","sAjaxSource":null,"sCookiePrefix":"SpryMedia_DataTables_","sDom":"lfrtip","sPaginationType":"two_button","sScrollX":"","sScrollXInner":"","sScrollY":"","sServerMethod":"GET"};DataTable.defaults.columns={"aDataSort":null,"asSorting":["asc","desc"],"bSearchable":true,"bSortable":true,"bUseRendered":true,
...
"bAjaxDataGet":true,"jqXHR":null,"fnServerData":null,"aoServerParams":[],"sServerMethod":null,"fnFormatNumber":null,"aLengthMenu":null,"iDraw":0,"bDrawing":false,"iDrawError":-1,"_iDisplayLength":10,"_iDisplayStart":0,"_iDisplayEnd":10,"_iRecordsTotal":0,"_iRecordsDisplay":0,"bJUI":null,"oClasses":{},"bFiltered":false,"bSorted":false,"bSortCellsTop":null,"oInit":null,"aoDestroyCallback":[],"fnRecordsTotal":function(){if(this.oFeatures.bServerSide)return parseInt(this._iRecordsTotal,10);else return this.aiDisplayMaster.length},
"fnRecordsDisplay":function(){if(this.oFeatures.bServerSide)return parseInt(this._iRecordsDisplay,10);else return this.aiDisplay.length},"fnDisplayEnd":function(){if(this.oFeatures.bServerSide)if(this.oFeatures.bPaginate===false||this._iDisplayLength==-1)return this._iDisplayStart+this.aiDisplay.length;else return Math.min(this._iDisplayStart+this._iDisplayLength,this._iRecordsDisplay);else return this._iDisplayEnd},"oInstance":null,"sInstance":null,"iTabIndex":0,"nScrollHead":null,"nScrollFoot":null};
...
$([anStatic[2],anStatic[3]]).addClass(iPages===0||(iCurrentPage===iPages||oSettings._iDisplayLength===-1)?oClasses.sPageButtonStaticDisabled:oClasses.sPageButton)}}}});$.extend(DataTable.ext.oSort,{"string-pre":function(a){if(typeof a!="string")a=a!==null&&a.toString?a.toString():"";return a.toLowerCase()},"string-asc":function(x,y){return x<y?-1:x>y?1:0},"string-desc":function(x,y){return x<y?1:x>y?-1:0},"html-pre":function(a){return a.replace(/<.*?>/g,"").toLowerCase()},"html-asc":function(x,y){return x<
y?-1:x>y?1:0},"html-desc":function(x,y){return x<y?1:x>y?-1:0},"date-pre":function(a){var x=Date.parse(a);if(isNaN(x)||x==="")x=Date.parse("01/01/1970 00:00:00");return x},"date-asc":function(x,y){return x-y},"date-desc":function(x,y){return y-x},"numeric-pre":function(a){return a=="-"||a===""?0:a*1},"numeric-asc":function(x,y){return x-y},"numeric-desc":function(x,y){return y-x}});$.extend(DataTable.ext.aTypes,[function(sData){if(typeof sData==="number")return"numeric";else if(typeof sData!=="string")return null;
var sValidFirstChars="0123456789-";var sValidChars="0123456789.";var Char;var bDecimal=false;Char=sData.charAt(0);if(sValidFirstChars.indexOf(Char)==-1)return null;for(var i=1;i<sData.length;i++){Char=sData.charAt(i);if(sValidChars.indexOf(Char)==-1)return null;if(Char=="."){if(bDecimal)return null;bDecimal=true}}return"numeric"},function(sData){var iParse=Date.parse(sData);if(iParse!==null&&!isNaN(iParse)||typeof sData==="string"&&sData.length===0)return"date";return null},function(sData){if(typeof sData===
"string"&&(sData.indexOf("<")!=-1&&sData.indexOf(">")!=-1))return"html";return null}]);$.fn.DataTable=DataTable;$.fn.dataTable=DataTable;$.fn.dataTableSettings=DataTable.settings;$.fn.dataTableExt=DataTable.ext})})(window,document);
