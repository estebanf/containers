(function(a) {
    a.fn.dashboard = function(m) {
            ...
            a("." + b.columnClass).each(function() {
                a(this).children().each(function() {
                    if (a(this).hasClass(b.widgetClass)) {
                        if (k.getWidget(a(this).attr("id")) != null) {
                            if (n > 0) {
                                o += ","
                            }
        ...
        k.setLayout = function(n) {
            ...
            a("." + b.columnClass).sortable({
                ...
                receive: function(p, q) {
                    ...
                    //no need to refersh call on widget drag n drop 
                    /*o.element.trigger("widgetRefresh", {
                        widget: o
                    })*/
                },
        ...
        k.addWidget = function(r, p, accessible) {
        ...
        k.loadWidgets = function(n) {
            ...
            a(n).each(function() {
                var o = this.column;
                k.addWidget(this, k.element.find("." + b.columnPrefix + o), "true")
            });
        ...
        function h(n) {
            ...
            n.serialize = function() {
                k.log("entering serialize function", 1);
                var widgetObject = getWidgetObject(n.id);
                var q = '{"title" : "' + n.title + '","reportId" : "'+widgetObject.reportId+'", "id" : "' + n.id + '", "filter" : ' + JSON.stringify(widgetObject.filter) + ', "column" : "' + n.column + '","editurl" : "' + n.editurl + '","open" : ' + n.open + ',"url" : "' + n.url + '"';
                if (typeof n.metadata != "undefined") {
                    q += ',"metadata":{';
                    var s = n.metadata;
                    var o = 0;
            ...
            n.openFullscreen = function() {
                ...
                n.element.parent().attr("id", "placeholder_" + k.id);
                n.element.appendTo(o);
                n.element.trigger("widgetRefresh", {
                    widget: n
                });
                //n.refreshContent() // called to refresh content
            };
            n.closeFullscreen = function() {
                k.log("entering closeFullscreen function", 1);
                n.fullscreen = false;
                var o = a("#placeholder_" + k.id);
                n.element.appendTo(o);
        ...
        a(document).on("click", "#" + k.id + ".menutrigger", function() {
        ...
        a(document).on("click", "#addwidgetdialog .widgetitem input", function() {
            //disableWidget($(this), "Added");
        });
        a(document).on("click", "#" + k.id + " .widget-toolbar a .widgetopenfullscreen", function(o) {
        ...
        a(document).on("click", "#" + k.id + " .widget-toolbar a", function(o) {

            if ($(this).attr("id") != "changeChartType" && $(this).attr("id") != "refreshChart") {
                k.log("widgetCloseMenu event thrown for widget " + h.id, 2);
                var n = k.getWidget(a(this).closest("." + b.widgetClass).attr("id"));
                n.element.trigger("widgetCloseMenu", {
                    widget: n
        ...
        a(document).on("widgetCloseMenu", "#" + k.id + " ." + b.widgetClass, function(n, p) {
            k.log("Closing menu " + a(this).attr("id"), 1);
            p.widget.closeMenu()
        });
        a(document).on("widgetOpenMenu", "#" + k.id + " ." + b.widgetClass, function(n, p) {
            k.log("Opening menu " + a(this).attr("id"), 1);
            p.widget.openMenu()
        });
        a(document).on("widgetDelete", "#" + k.id + " ." + b.widgetClass, function(n, p) {
            //if (confirm(b.deleteConfirmMessage)) {
            k.log("Removing widget " + a(this).attr("id"), 1);
            //remove widget url+tab name from widget arr
            var n = k.getWidget(a(this).closest("." + b.widgetClass).attr("id"));
            if (n.fullscreen) {
                k.log("widgetCloseFullScreen event thrown for widget " + n.id, 2);
                n.element.trigger("widgetCloseFullScreen", {
            ...
            var removeStr = p.widget.url + "~" + $("#" + k.id).attr('name');
            widgetArr.splice($.inArray(removeStr, widgetArr), 1);
            p.widget.remove()
            //}
        });
        a(document).on("widgetRefresh", "#" + k.id + " ." + b.widgetClass, function(n, p) {
            p.widget.refreshContent()
        });
        a(document).on("widgetSetTitle", "#" + k.id + " ." + b.widgetClass, function(n, p) {
            p.widget.setTitle(p.title)
        });
        a(document).on("widgetClose", "#" + k.id + " ." + b.widgetClass, function(n, p) {
            k.log("Closing widget " + a(this).attr("id"), 1);
            p.widget.closeContent()
        });
        a(document).on("widgetOpen", "#" + k.id + " ." + b.widgetClass, function(n, p) {
            k.log("Opening widget " + a(this).attr("id"), 1);
            p.widget.openContent()
        });
        a(document).on("widgetShow", "#" + k.id + " ." + b.widgetClass, function() {
            a(this).find("." + b.widgetContentClass).show()
        });
        a(document).on("widgetHide", "#" + k.id + " ." + b.widgetClass, function() {
            a(this).find("." + b.widgetContentClass).hide()
        });
        a(document).on("widgetAddMetadataValue", "#" + k.id + " ." + b.widgetClass, function(n, p) {
        ...
        a(document).on("click", "#" + k.id + " ." + b.widgetTitleClass, function(o) {
        ...
        a(document).on("mouseover", "#" + k.id + " ." + b.widgetHeaderClass, function() {
            a(this).find("." + b.iconsClass).removeClass("hidden")
        });
        a(document).on("mouseout", "#" + k.id + " ." + b.widgetHeaderClass, function() {
            a(this).find("." + b.iconsClass).addClass("")
        });
        a("body").click(function() {
            a("." + b.menuClass).hide()
        });
        a(document).on("widgetOpenFullScreen", "#" + k.id + " ." + b.widgetClass, function(n, p) {
            p.widget.openFullscreen()
        });
        a(document).on("widgetCloseFullScreen", "." + b.widgetClass, function(n, p) {
            p.widget.closeFullscreen()
        });
        a(document).on("widgetEdit", "#" + k.id + " ." + b.widgetClass, function(n, p) {
        ...
        a(document).on("click", "." + d.openDialogClass, function() {
            k.log("dashboardOpenLayoutDialog event thrown", 2);
            k.element.trigger("dashboardOpenLayoutDialog");
            return false
        });
        k.element.on("dashboardOpenLayoutDialog", function() {
        ...
        k.element.on("dashboardStateChange", function() {
        ...
        k.element.on("dashboardCloseLayoutDialog", function() {
        ...
        function i() {
            ...
            a("." + d.selectLayoutClass).bind("click", function(q) {
                ...
                if (typeof b.layoutClass != "undefined") {
                    ...
                    /*on changing layout of a tab, all charts present in tab should be refreshed*/
                    k.element.find("." + b.widgetClass).each(function() {
                        var nWidget = k.getWidget(a(this).attr("id"));
        ...
        a(document).on("click", "." + l.selectCategoryClass, function() {
        ...
        k.element.on("addWidgetDialogSelectCategory", function(o, n) {
            ...
            if(parseInt(n.category.attr("id"))===6)
				getAdhocWidgets(false);
			else{
				...
				a.getJSON(url, {
					...
					a.each(p, function(s, t) {
						...
						//If the widget is already added in dashboard, disable that widget to add again..
						var tabsArray = dsState.tabs;
						for (var i = 0; i < tabsArray.length; i++) {
							if (tabsArray[i].tabName == $("#" + k.id).attr('name')) {
								var chartId = t.id.split('-')[2];
								if (jQuery.inArray(parseInt(chartId), widgetAccessArray) == -1)
									disableWidget($('#addwidget' + t.id), "Not Accessible");
								else
									$('#addwidget' + t.id).attr('value',$("#addButton").text());
							}
						}
					});
				});
        ...
        a(document).on("click", "." + l.addWidgetClass, function() {
        ...
        a(document).on("click", "." + l.openDialogClass, function() {
            k.log("dashboardOpenWidgetDialog event thrown", 2);
            k.element.trigger("dashboardOpenWidgetDialog");
            return false
        });
        k.element.on("dashboardOpenWidgetDialog", function() {
            ...
            a.getJSON(l.widgetDirectoryUrl, function(n) {
                ...
                if ($("#addwidgetdialog ul").has("li").length <= 0) {
                    ...
                    //Getting count of adhoc reports if any
                    getAdhocWidgets(true);
                }
            })
            if (responseData.licenseStatus == "NO_LICENSE" || responseData.licenseStatus == 'EXPIRED') {
                setTimeout(function() {
                    $("#addwidgetdialog ul li#4").remove();
                    $("#addwidgetdialog ul li#6").remove();
                }, 300);
            }
            
            if($("#sidebar ul li#moduleID7").length==0){
                setTimeout(function() {
                    $("#addwidgetdialog ul li#6").remove();
                },300);
            }
            if($("#sidebar ul li#moduleID39").length==0){
                setTimeout(function() {
                    $("#addwidgetdialog ul li#4").remove();
                },300);
            }
        ...
        $('#tabs').tabs({
            select: function(evt, ui) {
                ...
                if (currentDashboard != null && currentDashboard != undefined) {
                    k = currentDashboard;
                    reDrawTabsData(parseInt(ui.index));
                } else {
                    var tabsArray = dsState.tabs;
                    for (var i = 0; i < tabsArray.length; i++) {
                        if (tabsArray[i] != null && $.trim(tabsArray[i].tabName) == $.trim(currentTabName)) {
                            addNewDashboard(currentTab, tabsArray[i].info);
                            currentDashboard = dashboardManager.getDashboard(currentTab);
                            k = currentDashboard;
                            reDrawTabsData(parseInt(ui.index));
                            return k;
    ...
    a.fn.dashboard.defaults = {
        debuglevel: 3,
        json_data: {},
        loadingHtml: '<div class="loading"><img alt="Loading, please wait" src="/everteam/images/loading.gif" /><p>Loading...</p></div>',
        emptyColumnHtml: "",
        ...
        widgetClass: "widget",
        menuClass: "controls",
        widgetContentClass: "widget-body",
