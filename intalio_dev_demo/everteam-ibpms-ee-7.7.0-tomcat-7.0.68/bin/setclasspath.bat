...
set CLASSPATH=%CLASSPATH%;"%CATALINA_HOME%\bin\jcl-over-slf4j-1.7.6.jar";"%CATALINA_HOME%\bin\slf4j-api-1.7.6.jar";"%CATALINA_HOME%\bin\slf4j-log4j12-1.7.6.jar";"%CATALINA_HOME%\bin\log4j-1.2.17.jar";"%CATALINA_HOME%\var\config";
