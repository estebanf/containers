...
set SERVICE_NAME=IntalioBPMS
set PR_DISPLAYNAME=Intalio BPMS
...
set PR_DESCRIPTION=Intalio BPMS 7
set "PR_INSTALL=%EXECUTABLE%"
set "PR_LOGPATH=%CATALINA_BASE%\logs"
set "PR_CLASSPATH=%CATALINA_HOME%\bin\bootstrap.jar;%CATALINA_BASE%\bin\tomcat-juli.jar;%CATALINA_HOME%\bin\tomcat-juli.jar;%CATALINA_HOME%\bin\jcl-over-slf4j-1.7.6.jar;%CATALINA_HOME%\bin\slf4j-api-1.7.6.jar;%CATALINA_HOME%\bin\slf4j-log4j12-1.7.6.jar;%CATALINA_HOME%\bin\log4j-1.2.17.jar;%CATALINA_HOME%/var/log"
...
if exist "%CATALINA_HOME%\bin\servicesetenv.bat" call "%CATALINA_HOME%\bin\servicesetenv.bat"
...
echo Using JVMOPTIONS:       "%PR_JVMOPTIONS%"
